...
def get_ping_status(ip):
    try:
        # Create the startupinfo object and configure it to hide the window
...
window.close()
sg.Popup("Thanks for using IP Monitor//Sudo-Gate \U0001F47B ")  # This is the popup you see when the app closes
